...
public class GreetResource {
    ...
    private final GreetRestClient greetRestClient;
     ...
     *
     * @param greetRestClient rest client
     * @param greetingConfig  the configured greeting message
     */
    @Inject
    public GreetResource(GreetRestClient greetRestClient, GreetingProvider greetingConfig) {
        this.greetRestClient = greetRestClient;
    ...
    public JsonObject outbound(@PathParam("name") String name) {
        return greetRestClient.getMessage(name);
    }
    ...
    private JsonObject onFailureOutbound(String name) {
